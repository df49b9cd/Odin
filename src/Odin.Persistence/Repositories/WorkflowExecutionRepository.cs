...
SET
    ...
    retry_policy = CAST(@RetryPolicy AS jsonb),
    cron_schedule = @CronSchedule,
    parent_workflow_id = @ParentWorkflowId,
    parent_run_id = @ParentRunId,
    initiated_id = @InitiatedId,
    completion_event_id = @CompletionEventId,
    memo = CAST(@Memo AS jsonb),
    search_attributes = CAST(@SearchAttributes AS jsonb),
    auto_reset_points = CAST(@AutoResetPoints AS jsonb),
